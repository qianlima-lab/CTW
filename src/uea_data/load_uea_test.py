...
if __name__ == '__main__':
    ...
    uea = ['Epilepsy', 'EthanolConcentration', 'FaceDetection', 'FingerMovements', 'HandMovementDirection',
    ...
    for dataset_name in uea:
        ...
        # path = father_path + '/sc_results/' + '14_uea_sc_20211227.csv'
