...
--embedding_size 32 --ni 0.3 --num_workers 2 --add_noise_interval 1 --aug TimeWarp \
...
--embedding_size 32 --ni 0.3 --num_workers 2 --add_noise_interval 1 --aug TimeWarp --mean_loss_len 10 --gamma 0.3 \
